export default function Home() {
  return (
    <section className="min-h-screen w-full bg-gradient-to-br from-purple-600 via-blue-500 to-indigo-500 text-white animate-fade-in flex flex-col items-center justify-center px-6 py-12">
      ...
      {/* Title + Tagline */}
      <h1 className="text-7xl font-extrabold mb-8 drop-shadow-2xl text-yellow-300">
      ...
      <div className="space-x-10">
        <a href="/login" className="bg-yellow-400 text-purple-800 font-bold px-12 py-4 rounded-lg shadow-lg hover:bg-yellow-300 transition transform hover:-translate-y-1 text-2xl">
          🚀 Get Started
        </a>

        <a href="/about" className="bg-white text-purple-600 font-bold px-12 py-4 rounded-lg shadow hover:bg-gray-100 transition transform hover:-translate-y-1 text-2xl">
